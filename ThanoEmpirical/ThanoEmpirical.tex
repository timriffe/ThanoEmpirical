...
Question & Male \% Thano & Female \% Thano \\ 
  \hline
Self-rated memory & \% 59.9 \Cell{srmMales.pdf} & \% 83.9 \Cell{srmFemales.pdf} \\ 
  Memory compared to past & \% 72.8 \Cell{pastmemMales.pdf} & \% 84.6 \Cell{pastmemFemales.pdf} \\ 
  Serial 7s & \% 78.3 \Cell{ssMales.pdf} & \% 51.2 \Cell{ssFemales.pdf} \\ 
  Backwards counting & \% 79.5 \Cell{c20bMales.pdf} & \% 54.3 \Cell{c20bFemales.pdf} \\ 
  Naming month & \% 80.6 \Cell{namemoMales.pdf} & \% 63.0 \Cell{namemoFemales.pdf} \\ 
  Naming day of month & \% 80.6 \Cell{namedmoMales.pdf} & \% 67.8 \Cell{namedmoFemales.pdf} \\ 
  Naming year & \% 76.8 \Cell{nameyrMales.pdf} & \% 54.7 \Cell{nameyrFemales.pdf} \\ 
  Naming day of week & \% 85.9 \Cell{namedwkMales.pdf} & \% 70.0 \Cell{namedwkFemales.pdf} \\ 
  Naming scissors & \% 77.1 \Cell{namesciMales.pdf} & \% 67.5 \Cell{namesciFemales.pdf} \\ 
  Naming cactus & \% 50.4 \Cell{namecacMales.pdf} & \% 52.0 \Cell{namecacFemales.pdf} \\ 
  Naming president & \% 80.9 \Cell{namepresMales.pdf} & \% 33.9 \Cell{namepresFemales.pdf} \\ 
  Naming VP & \% 73.6 \Cell{namevpMales.pdf} & \% 52.0 \Cell{namevpFemales.pdf} \\ 
  Vocabulary score & \% 79.4 \Cell{vocabMales.pdf} & \% 52.8 \Cell{vocabFemales.pdf} \\ 
  Mental status summary & \% 81.6 \Cell{tmMales.pdf} & \% 52.0 \Cell{tmFemales.pdf} \\ 
  Delayed word recall & \% 55.2 \Cell{dwrMales.pdf} & \% 28.8 \Cell{dwrFemales.pdf} \\ 
  Total word recall & \% 56.0 \Cell{twrMales.pdf} & \% 34.2 \Cell{twrFemales.pdf} \\ 
  Immediate word recall & \% 56.7 \Cell{iwrMales.pdf} & \% 41.3 \Cell{iwrFemales.pdf} \\ 
  Memory prob. at interview & \% 89.7 \Cell{mprobMales.pdf} & \% 86.8 \Cell{mprobFemales.pdf} \\ 
  Memory prob. Ever & \% 90.3 \Cell{mprobevMales.pdf} & \% 79.6 \Cell{mprobevFemales.pdf} \\ 
   \hline
\end{tabular}
\end{table}
\FloatBarrier
