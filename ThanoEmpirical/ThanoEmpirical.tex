...
Note that smoothing over these three particular time dimensions is not an
...
cohort. These four major axes of variation provide a way to categorize and
understand markers of ageing. We summarize the results of our set of 78
characteristics by calculating Pearson correlation coefficients along each of
...
apparent chronological age pattern along said margin is by coincidence only. Instead, such characteristics appear to more closely operate as effects of
the body shutting down or possibly as a signal on average that death is not far off, a demographic corroboration of substantive findings in the psychology literature \citep{carstensen2006influence}. Many characteristics studied here displayed patterns that are strongly thanatological.

Figure~\ref{fig:back} tells just the opposite story about back pain for females.
Back pain, as a matter of demographic timekeeping, is a function of
...
process. For many characteristics it is wrong, but for back problems it is
correct. In these ages, back problems provide no information about remaining
years of life. Of the characteristics included in this
study, only \textit{current} smoking, arthritis, and self reports of current versus former memory exhibit such clear chronological patterns (both for males and
females).
...
and diabetes among females. Sometimes such patterns combine to form complex
patterns in need of further study.
...
having been diagnosed with high blood pressure. Arithmetically, $years~lived -
years~left$ is the operative predictor of blood pressure, but blood pressure is
not useful alone in predicting eventual lifespan.\footnote{We do not have
expertise to comment further on blood pressure, but instead only provide an
interpretation of the surface presented.}
...
were produced for all 78 variables and each sex. We distill these surfaces by
calculating four Pearson correlation coefficients, each designed to capture the
variation along one of the axes explained above. We call the four axes
thanatological, chronological, lifespan ($chrono+thano$), and mixed
($chrono-thano$). Most characteristics are summarized nicely be either one or
two of these axes. We display these correlation coefficients by juxtaposing
perpendicular axes in scatterplots. 
...
\begin{figure}[!h]
    ...
    \caption{Males, 1915-1919 birth cohort}
    \label{fig:malcorr1}
	\vspace{-2em}
    ...
    \caption{Females, 1915-1919 birth cohort}
    \label{fig:femcorr1}
	\vspace{-2em}
...
respectively, a different picture overall. Both point clouds are high, but
females lean further towards chronological variation within this cohort.
...
must be tempered by noting that 1) the summary measure (correlation coefficient) used here blends out some information, 2) this balance does not necessarily extrapolate to the set of all testable
questions in the HRS, and 3) this relationship does not necessarily hold in
other windows of the lifespan or other birth cohorts. Research to better
document the multidimensional age variation of particular caracteristics would
benefit from more careful measurement than that used here. Despite such
shortcomings, the principle aim of this study has been satisfied in that this
survey highlights the complex variety of age and lifespan dimensions over which
some key aspects of the aging process unfold. All of the indicators we tested
are commonly used to describe population ageing, and very few of them are
exclusively a function of chronological age. If this finding is sustained in
other cohorts and populations, and if other indicators here untested also
display similar temporal complexity, we submit that the common discourse and
debate on the nature and impacts of ageing ought to be better informed by this
information.

We hope that the mental model of the
lifespan presented here, which complements the Lexis diagram, will be of use to
demographers. A series of direct applications and implications derive from the
results presented int this paper. First, if
...
been) happening or not. That is, changing chronological age patterns may be
coincidental, and they are not necessarily predictive either (this is an
empirical question). 
...
Third,
physicians and the public may better situate the association of certain health outcomes with stages of the ageing process. 

Fourth, this material highlights important sex differences in the onset and
trajectory of some aspects of morbidity. Some such differences may corroborate
extant findings, and others may provide new understanding to dimorphism in
morbidity.

We do not at this time attempt to thoroughly cluster characteristics based on the scores of the four different correlation coefficients, but this may be a fruitful exercise for further work.
It is our hope that these results are strongly suggestive and orient
investigation.
...
For tables displayed in following we use a shorthand to identify axis types. T
indicates the correlation coefficient along the thanatological age axis. C
...
\centering
\caption{Activities of Daily Life (ADL)}
\begin{tabular}{L{4em}
...
\centering
\caption{Instrumental Activities of Daily Life (IADL)}
\begin{tabular}{L{4em}
L{2cm}|C{1cm}C{1cm}C{1cm}C{1cm}|C{1cm}C{1cm}C{1cm}C{1cm}}
  \multicolumn{2}{c|}{Variable}&\multicolumn{4}{c|}{Males} &
 \multicolumn{4}{c}{Females} \\
