...
function of time to death. In cases where a characteristic strongly varies as a function of
...
patterns from trends in mortality. This analytical step lends clarity to the
understanding of how characteristics vary over the lifespan and over time.
...
based only on chronological age profiles are vulnerable to being misleading.
...
We aim to identify a range of domains in which it makes
sense to think from a thanatological perspective, especially around various dimensions of morbidity
associated with the ageing process. Our analytical approach is retrospective
rather than prospective, meaning that no lifetable assumptions are made in the
fmeasurement o  In the following sections we describe our approach to this
exercise.
