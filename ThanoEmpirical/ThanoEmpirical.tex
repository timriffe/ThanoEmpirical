...
For an
individual, age across the life course is consists of two components: time since
...
is currently under review (self-cite blocked). \citet{brouard1986structure,
...
figures: (url goes here\ldots)} We restrict the sample to only those
