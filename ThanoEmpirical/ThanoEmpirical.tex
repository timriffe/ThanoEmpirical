...
We aim for a broad overview of the age variation over different aspects of
old-age disability and well-being. For this reason we select many questions from
various submodules of the HRS data. The major groups
