...
%\footnote{A paper on this
% topic is currently under review (self-cite blocked). \citet{brouard1986structure,
%brouard1989mouvements} had already done the same thing some 30 years earlier,
% and we understand that S. Scherbov also unwittingly produced the same result over a decade ago.}
%\citep{riffe2014paaposter}
