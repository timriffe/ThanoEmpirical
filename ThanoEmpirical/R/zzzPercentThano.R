## DEPRECATED. MY FIRST ATTEMPT WAS TO SUMMARIZE RESULTS IN TERMS OF
## DEGRESS THANATOLOGICAL, BUT THERE ARE MORE KINDS OF VARIATION THAN
# THIS, SO WE LOSE MUCH INFORMATION.
#
